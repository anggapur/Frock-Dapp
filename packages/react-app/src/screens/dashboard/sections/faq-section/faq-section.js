          ...
          <Col lg={6}>
            <Accordion defaultActiveKey="0" flush>
              <Accordion.Item eventKey="0" className={styles['accordion-item']}>
                ...
                <Accordion.Body className={styles['accordion-body']}>
                  The FROCK in total building trade dividends and the other FTM
                  values are as were paid out. The displayed values in other
                  tokens/currencies are based on the current rates according to
                  CoinGecko.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
