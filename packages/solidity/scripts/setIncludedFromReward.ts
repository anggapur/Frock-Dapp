...
/**
 * @dev to run this function :  yarn solidity run-local scripts/setIncludedFromReward.ts --address [address]
 */
async function main() { 
    ...
    // Exclude From Reward
    await dividenDistributor.connect(deployer).excludedFromReward(address, false);
